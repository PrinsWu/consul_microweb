...
microuser_service_name = (os.environ['MICROUSER_SERVICE_NAME'] if 'MICROUSER_SERVICE_NAME' in os.environ else "consul_microweb_microuser")
microtalk_service_name = (os.environ['MICROTALK_SERVICE_NAME'] if 'MICROTALK_SERVICE_NAME' in os.environ else "consul_microweb_microtalk")
